  ...
  <div>
    ...
    <div class="yy bg-gray-100 h-screen">
      ...
      <div class="tisdlsd pt-20">
        ...
        >
          <h1 class="text-black font-semibold text-2xl">Workspace</h1>
          <div class="create-p-bnt">
            <button
              @click="createWorkspaceModal = true"
      ...
      <!-- <div class="workspaces-con space-mb-sides">
        <div class="pro-cards p-2">
          <div class="pro-card bg-white shadow-sm border boder-gray-100 p-2 w-1/6">
            <div class="pro-hd">
              <h1>Development</h1>
            </div>
          </div>
      ...
      <div class="skdsd ml-1 flex mt-3 space-mb-sides">
        <div class="w-full p-2">
          <div class="sd col-start-1 w-full">
            <p class="text-sm text-gray-500">All Workspace</p>
          </div>
      ...
      <div class="grid grid-cols-4 workspace-list pb-20 bg-gray-100">
        <div
          class="ml-6 p-4 mt-2 workspace-list-items bg-white shadow rounded w-64 h-40 mb-5 relative"
          v-for="workspaceData in getWorkspaceData"
      ...
      <div
        class="works-create animate-slidemodalfromright bg-white w-full absolute top-10 h-screen"
        id="_2933"
        v-if="createWorkspaceModal"
        ref="createWorkspaceModal"
      >
        <div class="dkd p-4 mt-5">
          <div
            class="close-btn hover:bg-gray-100 round-circle cursor-pointer"
            @click="clearWorkspaceModal"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
            ...
            <div class="pse p-4">
              ...
              <div class="di mt-10">
                <div class="dld relative">
                  ...
                  >
                    <p class="text-xs">workspace name can't be empty.</p>
                  </div>
                </div>
                ...
                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                  ...
                  <div class="mt-2">
                    <p class="text-sm text-gray-500">
                      You're about to delete this workspace
...
export default {
  ...
  methods: {
    ...
    createWorkspace() {
      const workspaceData = {
        ...
        description: this.worksDescription,
        ID: this.worksID,
      };
      createWorkspace(workspaceData)
        ...
        .then(() => {
          setTimeout(() => {
            this.loaded = false;
            this.createWorkspaceModal = false;
            this.spinner = false;
            this.workspaceName = "";
            this.worksDescription = "";
            this.worksID = generateUID();
            this.error = "";
          }, 1600);
        })
        .catch((error) => {
    ...
    showDeleteWorkspaceModal(name, path) {
      this.deleteModal = true;
      this.deleteWorkspaceName = name;
      this.deleteWorkspacePath = path;
    },
    confirmDeleteWorkspace() {
      deleteWorkspace(this.deleteWorkspacePath);
  ...
  computed: mapGetters(["getWorkspaceData"]),
  created() {
    getAllWorkspace();
  },
  watch: {
    createWorkspaceModal: function (data) {
      if (data === true) {
        if (data === true) {
          setTimeout(() => {
        ...
        setTimeout(() => {
          if (!this.workspaceName) {
            this.$refs.createworksBtn.disabled = true;
            this.$refs.createworksBtn.style.cursor = "not-allowed";
          }
          this.$refs.workspaceName.addEventListener("keyup", () => {
            let reg = /[^a-z0-9]/gi;
            this.workspaceName = this.workspaceName.replace(reg, "");
            if (!this.workspaceName) {
              this.$refs.createworksBtn.disabled = true;
              this.$refs.createworksBtn.classList.remove(
                "bg-main-normal",
                "text-white"
              );
              this.$refs.createworksBtn.style.cursor = "not-allowed";
              this.$refs.createworksBtn.classList.add(
                "bg-gray-300",
                "text-gray-400"
              );
              ...
              this.$refs.createworksBtn.disabled = false;
              this.$refs.createworksBtn.style.cursor = "pointer";
              this.$refs.createworksBtn.classList.remove(
                "bg-gray-300",
                "text-gray-400"
              );
